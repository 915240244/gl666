...
<body>
	...
	<div class="header" id="header">
		<div class="container">
			<div class="logo">
				<a href="/keji.do"><img src="images/logo.png" alt="" /></a>
			</div>
	...
	<div class="navigation-strip">
		<div class="container">
			<div class="nav_content">
				<div class="home">
					<a href="geren.do"><img src="images/home.png" alt="" /></a>
				</div>
	...
	<div class="content">
		<div class="container">
			<div class="blog-section">
				<h4 class="head">科技类书籍<span class="line"></span></h4>
				<div class="blog-post-grids">
                    <c:forEach var="book" items="${kjbooks}">
					<div class="col-md-4 blog-posts">
						<div class="blog-post">
								...
								<div style="margin: auto 4%;margin-top:5px">状态:<c:choose>
                                    ...
                                    <button class="jkl" lang="${book.book_ID}">点击查询</button>
                                </div>
								<span></span>
						...
						<c:forEach var="book" items="${researchBook}">
							<div class="col-md-4 blog-posts">
								<div class="blog-post">
									...
									<div style="margin: auto 4%;margin-top:5px">作者:${book.author}</div>
									<div style="margin: auto 4%;margin-top:5px">出版日期:${book.publication_Date}</div>
									<div style="margin: auto 4%;margin-top:5px">状态:
										<c:choose>
											<c:when test="${book.stocks==0}">不可借</c:when>
											<c:when test="${book.stocks==1}">可借</c:when>
										</c:choose> <a href="findBook.do?book_ID=${book.book_ID}">点击查询</a></div>
									<span></span>
									<p>简介：${book.synopsis}</p >
								</div>
							</div>
				...
				<div class="pagination text-center">
					<div class="j_page" style="height: 100px;">
                         ...
                         <%--这里有问题，分页value问题--%>
						<input type="hidden" id="pageNum" value="${kjbooks.getPageNum()}">
						<input type="hidden" id="totalPage" value="${kjbooks.getPages()}">
						<span onclick="firstPage()">首页</span> <span onclick="prePage()">上一页</span>
                             <input style="width: 50px;" type="text" value="${kjbooks.getPageNum()}">
...
/*    function sou() {
    ...
    function firstPage(){
        ...
        if(1==pageNum){
            ...
            window.location.href="<%=request.getContextPath()%>keji.do?pageNum="+1;
        }
    }
    function prePage(){
        var pageNum=document.getElementById("pageNum").value;
        if (pageNum==1){
            ...
            pageNum--;
            window.location.href="<%=request.getContextPath()%>keji.do?pageNum="+pageNum;
        }
    ...
    function lastPage(){
        ...
        if(pageNum==totalPage){
            ...
            window.location.href="<%=request.getContextPath()%>keji.do?pageNum="+totalPage;
        }
    }
</script>
