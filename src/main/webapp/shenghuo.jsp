...
<div class="header" id="header">
    <div class="container">
        <div class="logo">
            <a href="/shenghuo.do"><img src="images/logo.png" alt=""/></a>
        </div>
...
<div class="content">
    <div class="container">
        <div class="blog-section">
            <h4 class="head">生活类书籍<span class="line"></span></h4>
            <div class="blog-post-grids">
                <c:forEach var="book" items="${shbooks}">
                    <div class="col-md-4 blog-posts">
                        <div class="blog-post">
                            ...
                            </c:choose> <button class="jkl" lang="${book.book_ID}">点击查询</button></div>
                            <span></span>
            ...
            <div class="pagination text-center">
                <div class="j_page" style="height: 100px;">
                    ...
                    <%--这里有问题，分页value问题--%>
                    <input type="hidden" id="pageNum" value="${shbooks.getPageNum()}">
                    <input type="hidden" id="totalPage" value="${shbooks.getPages()}">
                    <span onclick="firstPage()">首页</span> <span onclick="prePage()">上一页</span>
                    <input style="width: 50px;" type="text" value="${shbooks.getPageNum()}">
...
<script type="text/javascript">
    $(".jkl").click(function () {
        ...
        $.ajax({
            ...
            success:function(data){
                if(data=="success"){
                    alert("借阅成功");
                    window.location.href="shenghuo.do"}
                else if(data=="fail"){
                    alert("已经没有书可借了");
                }   else if(data=="fails"){
                    alert("出现了出乎意料的错误");
    ...
    function firstPage() {
        ...
        if (1 == pageNum) {
            ...
            window.location.href = "<%=request.getContextPath()%>shenghuo.do?pageNum=" + 1;
        }
    }
    ...
    function prePage() {
        ...
        if (pageNum == 1) {
            ...
            pageNum--;
            window.location.href = "<%=request.getContextPath()%>shenghuo.do?pageNum=" + pageNum;
        }
    ...
    function lastPage() {
        ...
        if (pageNum == totalPage) {
            ...
            window.location.href = "<%=request.getContextPath()%>shenghuo.do?pageNum=" + totalPage;
        }
    }
</script>
