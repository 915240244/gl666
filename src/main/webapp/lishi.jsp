...
<div class="header" id="header">
    <div class="container">
        <div class="logo">
            <a href="/lishi.do"><img src="images/logo.png" alt=""/></a>
        </div>
...
<div class="content">
    <div class="container">
        <div class="blog-section">
            <h4 class="head">历史类书籍<span class="line"></span></h4>
            <div class="blog-post-grids">
                <c:forEach var="book" items="${lsbooks}">
            ...
            <div class="pagination text-center">
                <div class="j_page" style="height: 100px;">
                    ...
                    <%--这里有问题，分页value问题--%>
                    <input type="hidden" id="pageNum" value="${lsbooks.getPageNum()}">
                    <input type="hidden" id="totalPage" value="${lsbooks.getPages()}">
                    <span onclick="firstPage()">首页</span> <span onclick="prePage()">上一页</span>
                    <input style="width: 50px;" type="text" value="${lsbooks.getPageNum()}">
...
<script type="text/javascript">
    ...
    function firstPage() {
        ...
        if (1 == pageNum) {
            ...
            window.location.href = "<%=request.getContextPath()%>lishi.do?pageNum=" + 1;
        }
    }
    ...
    function prePage() {
        ...
        if (pageNum == 1) {
            ...
            pageNum--;
            window.location.href = "<%=request.getContextPath()%>lishi.do?pageNum=" + pageNum;
        }
    ...
    function lastPage() {
        ...
        if (pageNum == totalPage) {
            ...
            window.location.href = "<%=request.getContextPath()%>lishi.do?pageNum=" + totalPage;
        }
    }
</script>
