...
<div class="content">
    <div class="container">
        <div class="blog-section">
            <h4 class="head">最新推荐<span class="line"></span></h4>
            ...
            <div class="pagination text-center">
                <div class="j_page" style="height: 100px;">
                    ...
                    <%--这里有问题，分页value问题--%>
                    <input type="hidden" id="pageNum" value="${bookList.getPageNum()}">
                    <input type="hidden" id="totalPage" value="${bookList.getPages()}">
                    <span onclick="firstPage()">首页</span> <span onclick="prePage()">上一页</span>
                    <input style="width: 50px;" type="text" value="${bookList.getPageNum()}">
...
<script type="text/javascript">
    ...
    function firstPage() {
        ...
        if (1 == pageNum) {
            ...
            window.location.href = "<%=request.getContextPath()%>index.do?pageNum=" + 1;
        }
    }
    ...
    function prePage() {
        ...
        if (pageNum == 1) {
            ...
            pageNum--;
            window.location.href = "<%=request.getContextPath()%>index.do?pageNum=" + pageNum;
        }
    ...
    function lastPage() {
        ...
        if (pageNum == totalPage) {
            ...
            window.location.href = "<%=request.getContextPath()%>index.do?pageNum=" + totalPage;
        }
    }
</script>
